...
import com.payflowx.order.exception.MerchantServiceUnavailableException;
...
public class MerchantValidationServiceImpl implements MerchantValidationService {
    ...
    @Override
    @CircuitBreaker(name = "merchantService", fallbackMethod = "merchantFallback")
    ...
    public InternalMerchantValidationResponse merchantFallback(UUID userId, Exception ex) {
        throw new MerchantServiceUnavailableException("merchant-service unavailable");
    }
}